...
public class Dashboard {
    ...
    DefaultTerminalFactory factory = new DefaultTerminalFactory()
            .setForceTextTerminal(false);  // allows fullscreen mode

    Terminal terminal = factory.createTerminal();
    terminal.enterPrivateMode();           // fullscreen raw mode
    ...
    private void draw() {
        ...
        double bat = sysMon.getBatteryPercent();
        String battery = df.format(bat) + "%";
